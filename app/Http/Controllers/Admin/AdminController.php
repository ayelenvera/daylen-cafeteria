...
class AdminController extends Controller
{
    ...
    public function bulkDelete(Request $request)
    {
        ...
        try {
            ...
            $existingIds = $existingProducts->pluck('id')->toArray();
    ...
    public function restore(Request $request)
    {
        ...
        $request->validate([
            ...
            'undo_data.products' => 'required|array',
            'undo_data.products.*' => 'array'
        ]);
        ...
        try {
            foreach ($undoData['products'] as $productData) {
                Product::create([
            ...
            return redirect()->route('admin.products')->with('error', 'Error al restaurar los productos');
        }
    }
